benchmark_folder="../../../../benchmark/benchmark_v4/"
...
python "../../../local_scripts/pipeline_input_table.py" -c "./params.yaml" --clear --table "$benchmark_folder""p1_table/benchmark_table.csv" --odb_gene_id_column gene_id -l Tetrapoda Vertebrata Metazoa -n 30
